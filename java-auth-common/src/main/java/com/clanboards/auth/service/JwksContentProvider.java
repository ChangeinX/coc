...
/**
 * Pluggable provider for JWKS content that can be implemented by consumers
 * to provide JWKS data from various sources (database, file, etc).
 */
public interface JwksContentProvider {
  ...
  /**
   * Returns the last updated timestamp of the JWKS content.
   * This can be used for smarter cache invalidation.
   * 
